...
export default function TicketingPage() {
  ...
  const handleTicketChange = (ticketType, change) => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-yellow-400 via-yellow-300 to-yellow-200">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-4">Discover Amazing Events</h1>
              ...
              >
                ...
                <CardContent className="pt-0">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button onClick={() => handleEventSelect(event)} className="bg-black text-white hover:bg-gray-800">
                      Select Tickets
                ...
                <CardContent className="p-6">
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1">
                      <Badge className="bg-yellow-500 text-black font-semibold mb-2">{selectedEvent.category}</Badge>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {selectedEvent.tickets.map((ticket) => (
                      <div key={ticket.type} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-4">
                            <span className="text-xl font-bold text-gray-900">${ticket.price}</span>
                            <div className="flex items-center gap-2">
                              <Button
                                variant="outline"
                                size="sm"
                              ...
                              <span className="w-8 text-center font-medium">{selectedTickets[ticket.type] || 0}</span>
                              <Button
                                variant="outline"
                                size="sm"
                                onClick={() => handleTicketChange(ticket.type, 1)}
